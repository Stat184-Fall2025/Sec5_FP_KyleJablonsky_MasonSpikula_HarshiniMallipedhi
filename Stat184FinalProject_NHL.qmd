...
nhl <- readr::read_csv("/Users/harshinimallipedhi/Downloads/nhl_2223.csv")
...
Data cleaning & feature creation: Mason (primary), Name B (reviewer)

Visualization design & figure captions: Name B (primary), Name A (reviewer)

Narrative + discussion + conclusion: Harshini Mallipedhi (primary), Name A (reviewer)

Report formatting (Quarto, cross-references, citations): Harshini Mallipedhi (primary), Name C (reviewer)
